 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Thomas");
		  toPrint += p1.toString("903111878");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Oscar Becerra");
		  toPrint += p2.toString("obecerra3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Parker");
		  toPrint += p3.toString("903190610");
          //Person4 replace P4 with your name
          // and gburdell4 with your gt id
          Person4 p4 = new Person4("Adebisi");
          toPrint += p4.toString("athompson88");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Alexander George-Kennedy");
                  toPrint += p5.toString("aegk3");
